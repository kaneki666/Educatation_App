...
type BlogDetailsRouteProp = RouteProp<HomeRoutes, 'EducationECommerceDetails'>;

interface BlogDetailsProps {
  route: BlogDetailsRouteProp;
  navigation: HomeNavigationProps<'EducationECommerceDetails'>;
}

const BlogDetails = ({route, navigation}: BlogDetailsProps) => {
  const itemData = route.params.item;
  const fileroute = route.params.fileroute;
